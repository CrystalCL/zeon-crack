package crystal.addons.elytra.bot;

import crystal.addons.CrystalCL;
import crystal.addons.elytra.utils.RenderPath;
import crystal.addons.elytra.utils.action.BotUtils;
import crystal.addons.elytra.utils.action.MiningUtil1;
import crystal.addons.elytra.utils.other.DirectionMath;
import crystal.addons.elytra.utils.other.TimerUtils;
import crystal.addons.modules.BlockUtilsWorld;
...
public class ElytraBaritone extends Module {
    ...
    public ElytraBaritone() {
        super(CrystalCL.PvE, "elytra-baritone", "FIRST ElytraBaritone for 1.17 | Leak Author: skidded from cookie client xd");
    }
