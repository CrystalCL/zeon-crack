...
public class GuiRenderer {
    ...
    private final Pool<Scissor> scissorPool;
    ...
    private final Stack<Scissor> scissorStack;
    ...
    public GuiRenderer() {
        this.scissorPool = new Pool<Scissor>(Scissor::new);
        this.scissorStack = new Stack();
    ...
    public void quad(double d, double d2, double d3, double d4, Color color, Color color2) {
        this.quad(d, d2, d3, d4, color, color, color2, color);
    }
