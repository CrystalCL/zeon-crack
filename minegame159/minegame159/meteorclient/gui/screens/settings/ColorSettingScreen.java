...
extends WindowScreen {
    ...
    private void setFromSetting() {
        ...
        if (settingColor.rainbowSpeed != this.rainbowSpeed.get()) {
            this.rainbowSpeed.set(settingColor.rainbowSpeed);
        }
    ...
    public ColorSettingScreen(GuiTheme guiTheme, Setting<SettingColor> setting) {
        ...
        this.rainbowSpeed = guiTheme.doubleEdit(setting.get().rainbowSpeed, 0.0, 0.025);
        this.rainbowSpeed.min = 0.0;
        this.rainbowSpeed.action = () -> this.lambda$new$0(setting);
        this.rainbowSpeed.small = true;
    ...
    private void lambda$new$0(Setting setting) {
        ((SettingColor)setting.get()).rainbowSpeed = this.rainbowSpeed.get();
        setting.changed();
    }
