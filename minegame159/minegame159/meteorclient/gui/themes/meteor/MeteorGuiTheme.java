...
extends GuiTheme {
    ...
    public final Setting<SettingColor> accountTypeColor;
    ...
    public MeteorGuiTheme() {
        ...
        this.scale = this.sgGeneral.add(new DoubleSetting.Builder().name("scale").description("Scale of the GUI.").defaultValue(1.0).min(1.0).sliderMin(1.0).sliderMax(4.0).onSliderRelease().onChanged(MeteorGuiTheme::lambda$new$0).build());
        ...
        this.accountTypeColor = this.color(this.sgTextColors, "account-type-text", "Color of account type text.", new SettingColor(150, 150, 150));
