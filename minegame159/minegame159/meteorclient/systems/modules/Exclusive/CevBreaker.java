...
extends Module {
    ...
    public CevBreaker() {
        ...
        this.b = this.sgGeneral.add(new EnumSetting.Builder().name("Mode").description("The mode.").defaultValue(Mode.Instant).build());
        ...
        this.pauseOnEat = this.sgGeneral.add(new BoolSetting.Builder().name("pause-on-eat").description("Pauses while eating.").defaultValue(false).build());
        this.pauseOnDrink = this.sgGeneral.add(new BoolSetting.Builder().name("pause-on-drink").description("Pauses while drinking potions.").defaultValue(false).build());
        this.pauseOnMine = this.sgGeneral.add(new BoolSetting.Builder().name("pause-on-mine").description("Pauses while eating.").defaultValue(false).build());
        this.swap = this.sgGeneral.add(new BoolSetting.Builder().name("swap").description("Swap hand on the pickaxe.").defaultValue(true).build());
        this.backswap = this.sgGeneral.add(new BoolSetting.Builder().name("back-swap").description("Swap hand on the pickaxe.").defaultValue(true).build());
    ...
    extends Enum<Mode> {
        ...
        public static final /* enum */ Mode Instant = new Mode();
