...
extends Module {
    ...
    public class_2338 SetRelative(int n, int n2, int n3) {
        return new class_2338(this.mc.field_1724.method_23317() + (double)n, this.mc.field_1724.method_23318() + (double)n2, this.mc.field_1724.method_23321() + (double)n3);
    }
    ...
    private void findTarget() {
        ...
        Optional<class_1309> optional = Streams.stream((Iterable)this.mc.field_1687.method_18112()).filter(class_1297::method_5805).filter(this::lambda$findTarget$12).filter(CustomCrystalAura::lambda$findTarget$13).filter(CustomCrystalAura::lambda$findTarget$14).filter(this::lambda$findTarget$15).filter(this::lambda$findTarget$16).min(Comparator.comparingDouble(this::lambda$findTarget$17)).map(CustomCrystalAura::lambda$findTarget$18);
    ...
    private void findPlacePos(class_1657 class_16572) {
        ...
        class_2338 class_23382 = this.target.method_24515();
        this.add(class_23382.method_10069(2, 0, 1));
    }
    ...
    private Stream<class_1297> getCrystalStream() {
        return Streams.stream((Iterable)this.mc.field_1687.method_18112()).filter(CustomCrystalAura::lambda$getCrystalStream$3).filter(this::lambda$getCrystalStream$4).filter(class_1297::method_5805).filter(this::lambda$getCrystalStream$5).filter(this::lambda$getCrystalStream$6).filter(this::lambda$getCrystalStream$7);
    }
    ...
    private class_243 findOpen(class_1309 var1_1) {
        block7: {
            block8: {
                block6: {
                    if (!CustomCrystalAura.$assertionsDisabled && this.mc.field_1724 == null) {
                        throw new AssertionError();
                    }
                    var2_2 = 0;
                    var3_3 = 0;
