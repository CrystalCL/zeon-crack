...
extends HudElement {
    ...
    public void update(HudRenderer hudRenderer) {
        ...
        this.modules.sort((arg_0, arg_1) -> this.lambda$update$0(hudRenderer, arg_0, arg_1));
        double d = 0.0;
        double d2 = 0.0;
    ...
    private int lambda$update$0(HudRenderer hudRenderer, Module module, Module module2) {
        int n;
    ...
    public ActiveModulesHud(HUD hUD) {
        ...
        this.rainbowSpeed = this.sgGeneral.add(new DoubleSetting.Builder().name("rainbow-speed").description("Rainbow speed of rainbow color mode.").defaultValue(0.025).sliderMax(0.1).decimalPlaces(4).build());
        this.rainbowSpread = this.sgGeneral.add(new DoubleSetting.Builder().name("rainbow-spread").description("Rainbow spread of rainbow color mode.").defaultValue(0.025).sliderMax(0.05).decimalPlaces(4).build());
    ...
    extends Enum<ColorMode> {
        public static final /* enum */ ColorMode Random;
        public static final /* enum */ ColorMode Rainbow;
        private static final ColorMode[] $VALUES;
        public static final /* enum */ ColorMode Flat;
        ...
        public static ColorMode valueOf(String string) {
            return Enum.valueOf(ColorMode.class, string);
        }
    }

    public static final class Sort
    extends Enum<Sort> {
        public static final /* enum */ Sort Biggest = new Sort();
        public static final /* enum */ Sort Smallest = new Sort();
        private static final Sort[] $VALUES = Sort.$values();
        ...
        public static Sort valueOf(String string) {
            return Enum.valueOf(Sort.class, string);
        }
    }
}
