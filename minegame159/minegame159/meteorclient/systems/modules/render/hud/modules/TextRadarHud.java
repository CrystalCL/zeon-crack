...
extends HudElement {
    ...
    public void render(HudRenderer hudRenderer) {
        ...
        for (class_1657 class_16572 : this.getPlayers()) {
            if (class_16572.equals((Object)this.mc.field_1724) || !this.friends.get().booleanValue() && Friends.get().contains(Friends.get().get(class_16572))) continue;
            d = this.box.getX();
            String string = class_16572.method_7334().getName();
            Color color = Friends.get().contains(Friends.get().get(class_16572)) ? Friends.get().getFriendColor(class_16572) : (Color)this.hud.primaryColor.get();
