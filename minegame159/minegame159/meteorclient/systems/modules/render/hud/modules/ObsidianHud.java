...
extends HudElement {
    ...
    public void render(HudRenderer hudRenderer) {
        ...
        if (this.isInEditor()) {
            RenderUtils.drawItem(class_1802.field_8281.method_7854(), (int)d, (int)d2, this.scale.get(), true);
        } else if (InvUtils.findItemWithCount((class_1792)class_1802.field_8281).count > 0) {
            RenderUtils.drawItem(new class_1799((class_1935)class_1802.field_8281, InvUtils.findItemWithCount((class_1792)class_1802.field_8281).count), (int)d, (int)d2, this.scale.get(), true);
        }
    }
