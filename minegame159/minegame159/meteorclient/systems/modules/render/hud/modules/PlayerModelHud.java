...
extends HudElement {
    ...
    public PlayerModelHud(HUD hUD) {
        ...
        this.scale = this.sgGeneral.add(new DoubleSetting.Builder().name("scale").description("Scale of player model.").defaultValue(2.0).min(1.0).sliderMin(1.0).sliderMax(4.0).build());
        ...
        this.customYaw = this.sgGeneral.add(new IntSetting.Builder().name("custom-yaw").description("Custom yaw for when copy yaw is off.").defaultValue(0).min(-180).max(180).sliderMin(-180).sliderMax(180).build());
        this.customPitch = this.sgGeneral.add(new IntSetting.Builder().name("custom-pitch").description("Custom pitch for when copy pitch is off.").defaultValue(0).min(-180).max(180).sliderMin(-180).sliderMax(180).build());
