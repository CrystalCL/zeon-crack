...
extends DoubleTextHudElement {
    ...
    extends Enum<TimeType> {
        public static final /* enum */ TimeType World = new TimeType();
        private static final TimeType[] $VALUES;
        public static final /* enum */ TimeType Local;

        public static TimeType valueOf(String string) {
            return Enum.valueOf(TimeType.class, string);
        }
