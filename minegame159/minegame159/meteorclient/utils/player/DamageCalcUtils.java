...
public class DamageCalcUtils {
    ...
    public static double anchorDamage(class_1309 class_13092, class_243 class_2432) {
        DamageCalcUtils.mc.field_1687.method_8650(new class_2338(class_2432), false);
        double d = DamageCalcUtils.bedDamage(class_13092, class_2432);
        DamageCalcUtils.mc.field_1687.method_8501(new class_2338(class_2432), class_2246.field_23152.method_9564());
        return d;
    }
    ...
    private static double getDamageForDifficulty(double d) {
        switch (1.$SwitchMap$net$minecraft$world$Difficulty[DamageCalcUtils.mc.field_1687.method_8407().ordinal()]) {
            case 1: {
                return 0.0;
            }
            case 2: {
