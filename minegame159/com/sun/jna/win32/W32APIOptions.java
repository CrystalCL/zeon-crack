...
extends StdCallLibrary {
    ...
    static {
        UNICODE_OPTIONS = Collections.unmodifiableMap(new HashMap<String, Object>(){
            ...
            {
                1 lIIIlIIIlIIlII;
                lIIIlIIIlIIlII.put("type-mapper", W32APITypeMapper.UNICODE);
                lIIIlIIIlIIlII.put("function-mapper", W32APIFunctionMapper.UNICODE);
            }
        });
        ASCII_OPTIONS = Collections.unmodifiableMap(new HashMap<String, Object>(){
            private static final /* synthetic */ long serialVersionUID = 1L;
            {
                2 llllllllllllllllllllllIIllIlllII;
                llllllllllllllllllllllIIllIlllII.put("type-mapper", W32APITypeMapper.ASCII);
                llllllllllllllllllllllIIllIlllII.put("function-mapper", W32APIFunctionMapper.ASCII);
            }
        });
